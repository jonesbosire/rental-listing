            ...
            <div class="row">
                <div class="col-lg-4 col-md-12 col-pad wow fadeInLeft delay-04s">
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-sm-12 cp-2">
                            <div class="most-popular-box-1">
                                <div class="thumb-photo">
                                    <img src="assets/img/popular-places/img-2.jpg" alt="img" class="img-fluid">
                        ...
                        <div class="col-lg-12 col-md-6 col-sm-12 cp-2">
                            <div class="most-popular-box-1">
                                <div class="thumb-photo">
                                    <img src="assets/img/popular-places/img-4.jpg" alt="img" class="img-fluid">
                                    <div class="content"></div>
                                    <div class="inner">
                                        <div class="info">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-pad cp-3 wow fadeInUp delay-04s d-none-992">
                    <div class="most-popular-box-1 mpb-2">
                        <div class="thumb-photo">
                            <img src="assets/img/popular-places/img-3.jpg" alt="img" class="img-fluid">
                            <div class="content"></div>
                            <div class="inner">
                                <div class="info">
                ...
                <div class="col-lg-4 col-md-12 col-pad wow fadeInRight delay-04s">
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-sm-12 cp-2">
                            <div class="most-popular-box-1">
                                <div class="thumb-photo">
                                    <img src="assets/img/popular-places/img-6.jpg" alt="img" class="img-fluid">
                                    <div class="content"></div>
                                    <div class="inner">
                                        <div class="info">
                        ...
                        <div class="col-lg-12 col-md-6 col-sm-12 cp-2">
                            <div class="most-popular-box-1">
                                <div class="thumb-photo">
                                    <img src="assets/img/popular-places/img-5.jpg" alt="img" class="img-fluid">
                                    <div class="content"></div>
                                    <div class="inner">
                                        <div class="info">
            ...
            <div class="row slick-carousel" data-slick='{"slidesToShow": 2, "responsive":[{"breakpoint": 1024,"settings":{"slidesToShow": 1}}, {"breakpoint": 768,"settings":{"slidesToShow": 1}}]}'>
                ...
                <div class="slick-slide-item">
                    <div class="testimonials-inner">
                        <div class="user">
                            <a href="#">
                                <img class="media-object" src="assets/img/avatar/avatar.jpg" alt="user">
                            </a>
                        </div>
                        <div class="testimonial-info">
                            <h3>
                ...
                <div class="slick-slide-item">
                    <div class="testimonials-inner">
                        <div class="user">
                            <a href="#">
                                <img class="media-object" src="assets/img/avatar/avatar-3.jpg" alt="user">
                            </a>
                        </div>
                        <div class="testimonial-info">
                            <h3>
        ...
        <div class="row">
                ...
                <div class="row blog-3">
                    <div class="col-lg-5 col-md-12 col-pad ">
                        <div class="blog-photo">
                            <img src="assets/img/blog/blog-6.jpg" alt="blog-3" class="img-fluid">
                            <div class="user">
                                <div class="avatar">
                    ...
                    <div class="col-lg-7 col-md-12 col-pad">
                        <div class="detail clearfix">
                            ...
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text<span class="d-none2-1200"> ever since the 1500s, when </span></p>
            ...
            <div class="col-lg-6 col-md-6 wow fadeInRight delay-04s">
                <div class="row blog-3">
                    <div class="col-lg-5 col-md-12 col-pad">
                        <div class="blog-photo">
                            <img src="assets/img/blog/blog-7.jpg" alt="blog-3" class="img-fluid blog-img">
                            <div class="user">
                                <div class="avatar">
                                    <img src="assets/img/avatar/avatar-2.jpg" alt="avatar" class="img-fluid rounded-circle">
                                </div>
                                <div class="name">
                                    <h5>Teseira</h5>
                                </div>
